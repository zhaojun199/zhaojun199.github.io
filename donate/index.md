...
<img src="{{ '/styles/images/zhifubao.PNG' | prepend: site.baseurl }}" alt="支付宝二维码付款给ZHAOJUN" width="310" />
...
<img src="{{ '/styles/images/weixin.PNG' | prepend: site.baseurl }}" alt="微信二维码付款给ZHAOJUN" width="310" />
